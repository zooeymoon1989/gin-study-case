...
// is compatible with the proto_buffers package it is being compiled against.
// A compilation error at this line likely means your copy of the
// proto_buffers package needs to be updated.
const _ = proto.ProtoPackageIsVersion3 // please upgrade the proto_buffers package
...
func init() {
	proto.RegisterFile("todo.proto_buffers", fileDescriptor_0e4b95d0c4e09639)
}
